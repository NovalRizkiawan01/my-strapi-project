...
export interface ApiJurusanJurusan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Jurusan: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiNilaiNilai extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::nilai.nilai'>;
  };
}

export interface ApiNr01Nr01 extends Struct.CollectionTypeSchema {
  collectionName: 'nr_01s';
  info: {
    singularName: 'nr-01';
    pluralName: 'nr-01s';
  ...
  attributes: {
    ...
    Nama: Schema.Attribute.Text;
    Angkatan: Schema.Attribute.String;
    Prodi: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::nr-01.nr-01'>;
  };
}
...
export interface ApiPelangganPelanggan extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    pelanggan: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::nr-01.nr-01': ApiNr01Nr01;
      'api::pelanggan.pelanggan': ApiPelangganPelanggan;
